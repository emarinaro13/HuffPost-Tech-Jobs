...
Responsibilities
----------------
* Work with world class Editors, Designers, and Product Managers to maintain and create the next generation HuffPost's Google Android apps for tablets and smartphones
* Prototype new and redesigned features that take full advantage advanced phone features including camera, location, and accelerometer  
* Develop high touch, smooth as silk, intuitive, and delightful apps
* Take advantage of the advanced features in Linux, Java, and the Android SDK
* Stay up-to-date on the innovations in mobile technology and platforms
* Ensure HuffPost take advantage of the best practices for mobile engineering
...
---------------------
* Expertise and experience with Eclipse IDE and Java programming
* Expertise and experience with Android SDK
* Expertise and experience with Google coding and design standards
