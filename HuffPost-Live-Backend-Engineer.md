...
---------------------
* Expertise and experience with Ruby and Ruby on Rails.
* Expertise and experience with MongoDB or other NOSql data stores.
* Experience with building REST APIs, and caching technologies (Memcached, Redis)
* Experience with message queues like RabbitMQ.
* Experience with websockets and near real-time message pushing.
